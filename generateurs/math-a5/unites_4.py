...
<div class="frame">
  ...
  <div class="exemple" style="text-align:center">
    2,4 × 100 = 240 m &nbsp;·&nbsp; 1,25 × 1000 = 1 250 m &nbsp;·&nbsp; 2,225 × 1000 = 2 225 m
  </div>
...
{bar_model('معًا 4 400 أوقية', [('الحذاء', 1100, 'var(--p-green)', '؟'), ('', 1100, 'var(--p-yell)', '؟'), ('الحقيبة ×3', 1100, 'var(--p-yell)', '؟'), ('', 1100, 'var(--p-yell)', '؟')], w=76, stagger=False, scale=.8)}''' + dots(1))}'''
...
{exo(5, '⭐⭐', 'في عمرك يتنفس الطفل حوالي 20 مرة في الدقيقة. كم مرة يتنفس في 24 ساعة؟' + dots(1))}'''
...
<div class="frame has-video">
  ...
  {formula('البعد الحقيقي = البعد على التصميم ÷ السلم', 'var(--p-green)')}
...
{figure_img(FIGS['fermiere_poules'], 28, 'تبيع مربّية الدجاج بيضها وتوظّف مدخراتها لتحصل على فائدة سنوية')}
