...
def s1_p2():
  ...
  <tr><th style="background:var(--p-yell);color:#7c4a12;width:50%">السكريات (تعطي الطاقة)</th>
      <th style="background:var(--p-rose);color:#8a3d2a">الدهون والبروتينات</th></tr>
  <tr><td style="height:6mm"></td><td></td></tr>
  <tr><td style="height:6mm"></td><td></td></tr>
</table>'''
    body = f'''
...
{exo(5, '⭐⭐', 'ما هو الغذاء الرئيسي في مجموعة النشويات عندنا في موريتانيا؟')}'''
...
ج) ما هو إجمالي إنفاقه الطاقوي في اليوم؟ &nbsp; د) هل طاقته المستهلكة تساوي طاقته المنفقة؟''' + dots(2))}
...
{exo(8, '⭐⭐', f'''كانت منطقة ما تغطي {MX('30 %')} من مساحتها بالأشجار عام 1990. اليوم لم يتبق سوى {MX('10 %')}.<br>
أ) بكم انخفضت نسبة الغطاء النباتي؟{dots(1)}
ب) في 1990 كانت الأشجار تغطي 30 % من المنطقة، وفي 2020 أصبحت 10 % (تنخفض 20 % كل 30 سنة). إذا استمر الوضع، فماذا سيبقى عام 2050؟{dots(1)}
